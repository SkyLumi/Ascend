...
<section id="articles" class="bg-white p-4 mb-4 rounded shadow">
    <h2 class="text-xl font-bold mb-4">Artikel</h2>
    <button class="mb-4 px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">Lihat Selengkapnya</button>
    <!-- Similar Table as above -->
</section>
@endsection
